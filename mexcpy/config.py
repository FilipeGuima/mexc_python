...
BLOFIN_TP1_TRAIL_API_KEY = os.getenv("BLOFIN_TP1_TRAIL_API_KEY", BLOFIN_API_KEY)
BLOFIN_TP1_TRAIL_SECRET_KEY = os.getenv("BLOFIN_TP1_TRAIL_SECRET_KEY", BLOFIN_SECRET_KEY)
BLOFIN_TP1_TRAIL_PASSPHRASE = os.getenv("BLOFIN_TP1_TRAIL_PASSPHRASE", BLOFIN_PASSPHRASE)
