"""
MEXC TP1 Strategy Implementation
...
- Matches original telegram_listener_tp1.py behavior exactly
"""
...
logger = logging.getLogger("MexcTP1Strategy")
...
class MexcTP1Strategy(MexcStrategy):
    ...
    async def execute_trade(self, data: dict, engine) -> str:
        """
        Execute trade with smart entry logic.
        Matches original telegram_listener_tp1.py execute_signal_trade() exactly.
        """
        symbol = data['symbol']
    ...
    async def _execute_update_signal(self, data: dict, engine) -> str:
        ...
        Matches original telegram_listener_tp1.py execute_update_signal() exactly.
        """
        symbol = data['symbol']
